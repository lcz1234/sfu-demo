// 组合子模块
// 封装统一导出 供业务使用的方法
import { SfuApiStore } from './sfuApi.Store'
import { MeetingSetStore } from './meetingSet.Store'
...
class RootStore {
  constructor() {
    ...
    // 对应的值 就是导入的子模块实例对象
    this.sfuApiStore = new SfuApiStore()
    this.meetingSetStore = new MeetingSetStore()
  }
}
